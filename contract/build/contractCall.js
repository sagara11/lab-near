...
let CrossContractCall = (_dec = NearBindgen({}), _dec2 = initialize({}), _dec3 = call({}), _dec4 = call({
  ...
  query_greeting() {
    const promise = NearPromise.new(this.hello_account).functionCall("get_greeting", NO_ARGS, NO_DEPOSIT, FIVE_TGAS).then(NearPromise.new(currentAccountId()).functionCall("query_greeting_callback", NO_ARGS, NO_DEPOSIT, FIVE_TGAS));
    return promise.asReturn();
  }

  query_greeting_callback() {
    const greeting = promiseResult(0);
  ...
  change_greeting({
    ...
    const promise = NearPromise.new(this.hello_account).functionCall("set_greeting", bytes(JSON.stringify({
      message: new_greeting
    })), NO_DEPOSIT, FIVE_TGAS).then(NearPromise.new(currentAccountId()).functionCall("change_greeting_callback", NO_ARGS, NO_DEPOSIT, FIVE_TGAS));
    return promise.asReturn();
  }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "query_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "query_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "query_greeting_callback", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "query_greeting_callback"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "change_greeting", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "change_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "change_greeting_callback", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "change_greeting_callback"), _class2.prototype)), _class2)) || _class);
function change_greeting_callback() {
  let _state = CrossContractCall._getState();

  if (!_state && CrossContractCall._requireInit()) {
    throw new Error("Contract must be initialized");
  }

  let _contract = CrossContractCall._create();

  if (_state) {
    CrossContractCall._reconstruct(_contract, _state);
  }

  let _args = CrossContractCall._getArgs();

  let _result = _contract.change_greeting_callback(_args);

  CrossContractCall._saveToStorage(_contract);

  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CrossContractCall._serialize(_result));
}
function change_greeting() {
  ...
  let _result = _contract.change_greeting(_args);
...
function query_greeting_callback() {
  ...
  let _result = _contract.query_greeting_callback(_args);
...
function query_greeting() {
  ...
  let _result = _contract.query_greeting(_args);
